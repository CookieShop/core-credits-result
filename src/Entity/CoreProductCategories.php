...
class CoreProductCategories
{
     ...
     * Set parent
     *
     * @param \Adteam\Core\Credits\Result\Entity\CoreProductCategories $parent
     *
     * @return CoreProductCategories
     */
    public function setParent(\Adteam\Core\Credits\Result\Entity\CoreProductCategories $parent = null)
    {
        $this->parent = $parent;
